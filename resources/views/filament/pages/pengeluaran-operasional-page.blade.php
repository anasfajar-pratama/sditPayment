...
<div style="display:flex;flex-direction:column;gap:1.25rem;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:0.75rem;">
        ...
        <div style="display:flex;align-items:center;gap:0.75rem;">
            <a href="{{ route('export.operasional', ['start' => $filterStart, 'end' => $filterEnd, 'tab' => $activeTab]) }}"
            ...
            <a href="{{ route('operasional.pdf', ['start' => $filterStart, 'end' => $filterEnd]) }}" target="_blank"
        ...
        @else
            ...
            <div style="background:#1f2937;color:#fff;padding:0.85rem 1.25rem;display:flex;justify-content:space-between;align-items:center;">
                <span style="color:#9ca3af;font-size:0.8rem;">
                    Total <strong style="color:#fdba74;">{{ $activeTab }}</strong>
