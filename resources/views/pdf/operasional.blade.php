...
<head>
    ...
    <style>
        ...
        .section-title { font-size: 9pt; font-weight: 700; margin: 8px 0 4px; padding: 3px 6px; background: #fff7ed; border-left: 3px solid #f97316; }
    ...
    <table>
        <tr class="grand-total">
            <td colspan="3" style="text-align:right;padding:8px 10px;font-size:10pt;">
                GRAND TOTAL PENGELUARAN OPERASIONAL
            </td>
...
<div class="footer">
    Laporan Pengeluaran Operasional — {{ \Carbon\Carbon::parse($start)->format('d/m/Y') }} s.d. {{ \Carbon\Carbon::parse($end)->format('d/m/Y') }}
